//flowbite.com sitesinden yüklenirken görünen şablona en çok benzeyen kodları buraya yapıştır.
const Loader = () => {
    const array = [1, 2, 4, 5, 6, 7, 8, 9, 0];
    return (
      <>
        {array.map((_, i) => (
          <div key={i} role="status" className=" p-4  shadow animate-pulse md:p-6">
